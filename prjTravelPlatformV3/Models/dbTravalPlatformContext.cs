...
public partial class dbTravalPlatformContext : DbContext
{
    ...
    public virtual DbSet<HotelCommentView> HotelCommentViews { get; set; }

    public virtual DbSet<RCarInfoView> RCarInfoViews { get; set; }

    public virtual DbSet<RCarModelInfoView> RCarModelInfoViews { get; set; }
    ...
    public virtual DbSet<TDcCouponList> TDcCouponLists { get; set; }

    public virtual DbSet<TDcCusCouponQty> TDcCusCouponQties { get; set; }

    public virtual DbSet<TDcExchangeItem> TDcExchangeItems { get; set; }

    public virtual DbSet<TDcExchangeRecord> TDcExchangeRecords { get; set; }

    public virtual DbSet<TDcProductType> TDcProductTypes { get; set; }

    public virtual DbSet<TDcQuestion> TDcQuestions { get; set; }
    ...
    public virtual DbSet<THcollection> THcollections { get; set; }
    ...
    public virtual DbSet<TdestionationFollow> TdestionationFollows { get; set; }

    public virtual DbSet<TfreeOrder> TfreeOrders { get; set; }

    public virtual DbSet<TfreePlan> TfreePlans { get; set; }

    public virtual DbSet<TfreePlanDetail> TfreePlanDetails { get; set; }

    public virtual DbSet<ThotelDetail> ThotelDetails { get; set; }

    public virtual DbSet<TplanRemark> TplanRemarks { get; set; }

    public virtual DbSet<Tpriority> Tpriorities { get; set; }
    ...
    public virtual DbSet<VDcouponView> VDcouponViews { get; set; }

    public virtual DbSet<VDcusCouponView> VDcusCouponViews { get; set; }

    public virtual DbSet<VDexchangeView> VDexchangeViews { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<FordersView>(entity =>
        {
            ...
            entity.Property(e => e.訂單日期).HasColumnType("datetime");
            entity.Property(e => e.訂單狀態).HasMaxLength(50);
            entity.Property(e => e.訂單編號)
                .IsRequired()
                .HasMaxLength(50);
            entity.Property(e => e.評價).HasMaxLength(200);
        });
        ...
        modelBuilder.Entity<FscheduleView>(entity =>
        {
            ...
            entity.Property(e => e.出發時間).HasColumnType("datetime");
            entity.Property(e => e.定價).HasColumnType("money");
            entity.Property(e => e.抵達時間).HasColumnType("datetime");
        ...
        modelBuilder.Entity<HotelCommentView>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("HotelCommentView");

            entity.Property(e => e.CustomerName).HasMaxLength(50);
            entity.Property(e => e.FCommentContent)
                .HasMaxLength(50)
                .HasColumnName("fCommentContent");
            entity.Property(e => e.FCommentScore)
                .HasColumnType("decimal(2, 1)")
                .HasColumnName("fCommentScore");
        ...
        modelBuilder.Entity<RCarInfoView>(entity =>
        {
            ...
            entity.Property(e => e.FDescription2)
                .HasMaxLength(30)
                .HasColumnName("fDescription2");
        ...
        modelBuilder.Entity<RCarModelInfoView>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("rCarModelInfoView");
        ...
        modelBuilder.Entity<RCarRentOrderDetailView>(entity =>
        {
            ...
            entity.Property(e => e.FRentServicePoint)
                .HasMaxLength(50)
                .HasColumnName("fRentServicePoint");
            entity.Property(e => e.FServicePoint)
                .HasMaxLength(50)
                .HasColumnName("fServicePoint");
        });
        ...
        modelBuilder.Entity<TCustomer>(entity =>
        {
            ...
            entity.Property(e => e.FIsLogin).HasColumnName("fIsLogin");
            entity.Property(e => e.FLastLoginDateTime)
                .HasColumnType("datetime")
                .HasColumnName("fLastLoginDateTime");
        ...
        modelBuilder.Entity<TDcCouponList>(entity =>
        {
            entity.HasKey(e => e.FCouponId).HasName("PK_tCouponList");

            entity.ToTable("tDcCouponList");
        ...
        modelBuilder.Entity<TDcCusCouponQty>(entity =>
        {
            entity.HasKey(e => e.Fid).HasName("PK_tCusCouponQty");

            entity.ToTable("tDcCusCouponQty");
            ...
            entity.HasOne(d => d.FCustomer).WithMany(p => p.TDcCusCouponQties)
                .HasForeignKey(d => d.FCustomerId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_tCusCouponQty_tCouponList");
        });

        modelBuilder.Entity<TDcExchangeItem>(entity =>
        {
            entity.HasKey(e => e.FProductId).HasName("PK_fExchangeItems");

            entity.ToTable("tDcExchangeItems");
        ...
        modelBuilder.Entity<TDcExchangeRecord>(entity =>
        {
            entity.HasKey(e => e.FId).HasName("PK_ExchangeRecords");

            entity.ToTable("tDcExchangeRecords");
            ...
            entity.HasOne(d => d.FMember).WithMany(p => p.TDcExchangeRecords)
                .HasForeignKey(d => d.FMemberId)
                .HasConstraintName("FK_tExchangeRecords_tCustomer");

            entity.HasOne(d => d.FProduct).WithMany(p => p.TDcExchangeRecords)
                .HasForeignKey(d => d.FProductId)
                .HasConstraintName("FK_tExchangeRecords_tExchangeItems");
        });

        modelBuilder.Entity<TDcProductType>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("tDcProductType");
        ...
        modelBuilder.Entity<TDcQuestion>(entity =>
        {
            entity.HasKey(e => e.FId).HasName("tquestion_fid_primary");

            entity.ToTable("tDcQuestion");
            ...
            entity.HasOne(d => d.FMember).WithMany(p => p.TDcQuestions)
                .HasForeignKey(d => d.FMemberId)
        ...
        modelBuilder.Entity<TFflightSchedule>(entity =>
        {
            ...
            entity.HasOne(d => d.FClass).WithMany(p => p.TFflightSchedules)
                ...
                .HasConstraintName("FK_tFFlightSchedule_tFClass");
        ...
        modelBuilder.Entity<THcollection>(entity =>
        {
            entity.HasKey(e => e.FSid);

            entity.ToTable("tHCollection");

            entity.Property(e => e.FSid).HasColumnName("fSId");
            entity.Property(e => e.FCustomerId).HasColumnName("fCustomerId");
            entity.Property(e => e.FHotelId).HasColumnName("fHotelId");

            entity.HasOne(d => d.FCustomer).WithMany(p => p.THcollections)
                .HasForeignKey(d => d.FCustomerId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_tHCollection_tHCollection");

            entity.HasOne(d => d.FHotel).WithMany(p => p.THcollections)
                .HasForeignKey(d => d.FHotelId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_tHCollection_tHotel");
        });
        ...
        modelBuilder.Entity<THcomment>(entity =>
        {
            ...
            entity.ToTable("tHComment", tb => tb.HasTrigger("UpdateAverageScore"));
        ...
        modelBuilder.Entity<THimage>(entity =>
        {
            ...
            entity.Property(e => e.FHotelId).HasColumnName("fHotelId");
            entity.Property(e => e.FHotelImage).HasColumnName("fHotelImage");
        ...
        modelBuilder.Entity<THorder>(entity =>
        {
            ...
            entity.Property(e => e.FCouponId).HasColumnName("fCouponId");
            entity.Property(e => e.FCustomerId).HasColumnName("fCustomerId");
            entity.Property(e => e.FGuestAddress)
                .HasMaxLength(50)
                .HasColumnName("fGuestAddress");
            entity.Property(e => e.FGuestCount).HasColumnName("fGuestCount");
            entity.Property(e => e.FGuestEmail)
                .HasMaxLength(50)
                .HasColumnName("fGuestEmail");
            entity.Property(e => e.FGuestName)
                .HasMaxLength(50)
                .HasColumnName("fGuestName");
            entity.Property(e => e.FGuestPhone)
                .HasMaxLength(50)
                .HasColumnName("fGuestPhone");
            entity.Property(e => e.FHotelId).HasColumnName("fHotelId");
            entity.Property(e => e.FOrderDate)
                .HasMaxLength(50)
                .HasColumnName("fOrderDate");
        ...
        modelBuilder.Entity<THotel>(entity =>
        {
            ...
            entity.Property(e => e.FIntro).HasColumnName("fIntro");
            ...
            entity.Property(e => e.FPhone)
                .HasMaxLength(50)
                .HasColumnName("fPhone");
            entity.Property(e => e.FRank).HasColumnName("fRank");
        ...
        modelBuilder.Entity<THroomTypeImage>(entity =>
        {
            ...
            entity.Property(e => e.FRoomTypeImgId).HasColumnName("fRoomTypeImgId");
        ...
        modelBuilder.Entity<TIorder>(entity =>
        {
            ...
            entity.Property(e => e.FOrderId)
                .HasMaxLength(50)
                .HasDefaultValueSql("([dbo].[GetOrderID_I]())")
                .HasColumnName("fOrderID");
        ...
        modelBuilder.Entity<TIproductListView>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("tIProductListView");
        ...
        modelBuilder.Entity<TIproductReview>(entity =>
        {
            ...
            entity.Property(e => e.FProductSpecId).HasColumnName("fProductSpecId");
            entity.Property(e => e.FReviewDate)
                .HasMaxLength(50)
                .HasColumnName("fReviewDate");

            entity.HasOne(d => d.FProductSpec).WithMany(p => p.TIproductReviews)
                .HasForeignKey(d => d.FProductSpecId)
                .HasConstraintName("FK_tIProductReview_tIProductSpec");
        });

        modelBuilder.Entity<TIproductReviewsView>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("tIProductReviewsView");
        ...
        modelBuilder.Entity<TIshoppingCart>(entity =>
        {
            ...
            entity.HasOne(d => d.FCustomer).WithMany(p => p.TIshoppingCarts)
                .HasForeignKey(d => d.FCustomerId)
                .HasConstraintName("FK_tIShoppingCart_tCustomer");
        ...
        modelBuilder.Entity<TIsupLogisticsView>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("tISupLogisticsView");
        ...
        modelBuilder.Entity<TMessageInfo>(entity =>
        {
            entity.HasKey(e => e.FId);

            entity.ToTable("tMessageInfo");

            entity.Property(e => e.FId).HasColumnName("fId");
            entity.Property(e => e.Message).HasMaxLength(50);
            entity.Property(e => e.SelfId).HasMaxLength(50);
            entity.Property(e => e.SelfMemberId).HasMaxLength(50);
            entity.Property(e => e.SendToId).HasMaxLength(50);
            entity.Property(e => e.SendToMemberId).HasMaxLength(50);
        ...
        modelBuilder.Entity<TRcarInfo>(entity =>
        {
            ...
            entity.HasOne(d => d.FModel).WithMany(p => p.TRcarInfos)
                ...
                .HasConstraintName("FK_tRCarInfo_tRCarModel");
        });
        ...
        modelBuilder.Entity<TRcarModel>(entity =>
        {
            ...
            entity.Property(e => e.FModelId).HasColumnName("fModelId");
            entity.Property(e => e.FCarType)
                .HasMaxLength(10)
                .IsUnicode(false)
                .IsFixedLength()
                .HasColumnName("fCarType");
            entity.Property(e => e.FImagePath)
                .HasMaxLength(50)
                .HasColumnName("fImagePath");
            entity.Property(e => e.FModelInUse).HasColumnName("fModelInUse");
            ...
            entity.Property(e => e.FNumOfLuggage).HasColumnName("fNumOfLuggage");
            entity.Property(e => e.FNumOfPsgr).HasColumnName("fNumOfPsgr");
            entity.Property(e => e.FPowerType)
                .HasMaxLength(10)
                .IsUnicode(false)
                .IsFixedLength()
                .HasColumnName("fPowerType");
            entity.Property(e => e.FRentalFee)
                .HasColumnType("money")
                .HasColumnName("fRentalFee");

            entity.HasOne(d => d.FCarTypeNavigation).WithMany(p => p.TRcarModelFCarTypeNavigations)
                .HasForeignKey(d => d.FCarType)
                .HasConstraintName("FK_tRCarModel_tRCarModelInfo");

            entity.HasOne(d => d.FPowerTypeNavigation).WithMany(p => p.TRcarModelFPowerTypeNavigations)
                .HasForeignKey(d => d.FPowerType)
                .HasConstraintName("FK_tRCarModel_tRCarModelInfo1");
        });

        modelBuilder.Entity<TRcarModelInfo>(entity =>
        {
            entity.HasKey(e => e.FCode);

            entity.ToTable("tRCarModelInfo");
        ...
        modelBuilder.Entity<TRcarRentOrderDetail>(entity =>
        {
            ...
            entity.HasOne(d => d.FCar).WithMany(p => p.TRcarRentOrderDetails)
                ...
                .HasConstraintName("FK_tRCarRentOrderDetail_tRCarInfo");
        ...
        modelBuilder.Entity<Tdestination>(entity =>
        {
            ...
            entity.HasOne(d => d.FpriorityNavigation).WithMany(p => p.Tdestinations)
                .HasForeignKey(d => d.Fpriority)
                .HasConstraintName("FK_TDestination_TPriority");
        });
        ...
        modelBuilder.Entity<TdestinationDetail>(entity =>
        {
            ...
            entity.Property(e => e.FdestinationId)
                .HasMaxLength(50)
                .HasColumnName("FDestinationId");
            entity.Property(e => e.FdestionationState).HasColumnName("FDestionationState");
            entity.Property(e => e.FdestionationTime)
                .HasPrecision(0)
                .HasColumnName("FDestionationTime");
            entity.Property(e => e.FtravelDay).HasColumnName("FTravelDay");
        ...
        modelBuilder.Entity<TdestionationFollow>(entity =>
        {
            entity.HasKey(e => e.Fid);

            entity.ToTable("TDestionationFollow");

            entity.Property(e => e.FcustomerId).HasColumnName("FCustomerId");
            entity.Property(e => e.FdestionationId)
                .HasMaxLength(50)
                .HasColumnName("FDestionationId");
            entity.Property(e => e.Ffollow).HasColumnName("FFollow");

            entity.HasOne(d => d.Fcustomer).WithMany(p => p.TdestionationFollows)
                .HasForeignKey(d => d.FcustomerId)
                .HasConstraintName("FK_TDestionationFollow_tCustomer");

            entity.HasOne(d => d.Fdestionation).WithMany(p => p.TdestionationFollows)
                .HasForeignKey(d => d.FdestionationId)
                .HasConstraintName("FK_TDestionationFollow_TDestination");
        });

        modelBuilder.Entity<TfreeOrder>(entity =>
        {
            entity.HasKey(e => e.ForderId);

            entity.ToTable("TFreeOrder");

            entity.Property(e => e.ForderId)
                .HasMaxLength(50)
                .HasColumnName("FOrderId");
            entity.Property(e => e.FcoupomId).HasColumnName("FCoupomId");
            entity.Property(e => e.FfreeId).HasMaxLength(50);
            entity.Property(e => e.FmemberId).HasColumnName("FMemberId");
            entity.Property(e => e.ForderDate)
                .HasColumnType("date")
                .HasColumnName("FOrderDate");
            entity.Property(e => e.ForderSate).HasColumnName("FOrderSate");
            entity.Property(e => e.Fprice)
                .HasColumnType("money")
                .HasColumnName("FPrice");
            entity.Property(e => e.Fqty).HasColumnName("FQty");

            entity.HasOne(d => d.Fcoupom).WithMany(p => p.TfreeOrders)
                .HasForeignKey(d => d.FcoupomId)
                .HasConstraintName("FK_TFreeOrder_tDcCouponList");

            entity.HasOne(d => d.Ffree).WithMany(p => p.TfreeOrders)
                .HasForeignKey(d => d.FfreeId)
                .HasConstraintName("FK_TFreeOrder_TFreePlan");

            entity.HasOne(d => d.Fmember).WithMany(p => p.TfreeOrders)
                .HasForeignKey(d => d.FmemberId)
                .HasConstraintName("FK_TFreeOrder_tCustomer");
        });

        modelBuilder.Entity<TfreePlan>(entity =>
        {
            entity.HasKey(e => e.FfreeId);

            entity.ToTable("TFreePlan");

            entity.Property(e => e.FfreeId)
                .HasMaxLength(50)
                .HasColumnName("FFreeId");
            entity.Property(e => e.FmemberId).HasColumnName("FMemberId");
            entity.Property(e => e.Fstate).HasColumnName("FState");
        });

        modelBuilder.Entity<TfreePlanDetail>(entity =>
        {
            entity.HasKey(e => e.FdestinationDetailId);

            entity.ToTable("TFreePlanDetail");
            ...
            entity.Property(e => e.FdestinationId)
                ...
                .HasColumnName("FDestinationId");
            entity.Property(e => e.FdestionationState).HasColumnName("FDestionationState");
            entity.Property(e => e.FdestionationTime).HasColumnName("FDestionationTime");
            entity.Property(e => e.FfreeId)
                .HasMaxLength(50)
                .HasColumnName("FFreeId");
            entity.Property(e => e.FtravelDay).HasColumnName("FTravelDay");

            entity.HasOne(d => d.Fcustomer).WithMany(p => p.TfreePlanDetails)
                .HasForeignKey(d => d.FcustomerId)
                .HasConstraintName("FK_TFreePlanDetail_tCustomer");

            entity.HasOne(d => d.Fdestination).WithMany(p => p.TfreePlanDetails)
                .HasForeignKey(d => d.FdestinationId)
                .HasConstraintName("FK_TFreePlanDetail_TDestination");

            entity.HasOne(d => d.Ffree).WithMany(p => p.TfreePlanDetails)
                .HasForeignKey(d => d.FfreeId)
                .HasConstraintName("FK_TFreePlanDetail_TFreePlan");
        });
        ...
        modelBuilder.Entity<ThotelDetail>(entity =>
        {
            ...
            entity.Property(e => e.FhotelId).HasColumnName("FHotelId");
            entity.Property(e => e.FroomNumber).HasColumnName("FRoomNumber");
            entity.Property(e => e.FtravelDay).HasColumnName("FTravelDay");
            entity.Property(e => e.FtravelId)
                .HasMaxLength(50)
                .HasColumnName("FTravelId");
        ...
        modelBuilder.Entity<Tpriority>(entity =>
        {
            ...
            entity.ToTable("TPriority");

            entity.Property(e => e.Fid)
                .ValueGeneratedNever()
                .HasColumnName("FId");
            entity.Property(e => e.FpriorityName)
                .HasMaxLength(50)
                .HasColumnName("FPriorityName");
        });
        ...
        modelBuilder.Entity<TtravelPlan>(entity =>
        {
            ...
            entity.Property(e => e.Fprice).HasColumnName("FPrice");
            entity.Property(e => e.Fself).HasColumnName("FSelf");
            entity.Property(e => e.Fstate).HasColumnName("FState");
            entity.Property(e => e.Fstock).HasColumnName("FStock");
        ...
        modelBuilder.Entity<VDcouponView>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("vDCouponView");
            ...
            entity.Property(e => e.優惠卷編號).ValueGeneratedOnAdd();
        ...
        modelBuilder.Entity<VDcusCouponView>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("vDCusCouponView");
        ...
        modelBuilder.Entity<VDexchangeView>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("vDExchangeView");
