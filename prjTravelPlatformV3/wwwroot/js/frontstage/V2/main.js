(function () {
    ...
    //function priceRangeSliderInit(maxValue, step) {
  ...
  `;
    ...
    const Header = (function () {
        ...
        function headerSticky() {
            ...
            if (currentPath === '/Customer/Hotels/List'
                || currentPath === '/Customer/Hotels/ListEdit'
                || currentPath.startsWith("/Customer/Hotels/HotelDetail")
                || currentPath.startsWith("/Customer/Hotels/HotelOrder")
                || currentPath.startsWith("/Customer/TravelPlan/Free")
                || currentPath.startsWith("/Customer/Userprofile")
                || currentPath.startsWith("/Customer/CarRent/CarLists")
                || currentPath.startsWith("/Customer/CarRent/CarDetails")
                || currentPath.startsWith("/Customer/CarRent/CarBooking")
                || currentPath === '/Customer/Visa/ProductSelect'
                || currentPath === '/Customer/Visa/InfoInput'
                || currentPath === '/Customer/Visa/OrderConfirm'

            ) {

                header.classList.add('bg-dark-1');
            ...
            gridCells.forEach((el, i) => {
                el.addEventListener('click', () => {
                    ...
                    if (completeState) {
                        ...
                        firstDate.innerHTML = `2024/${firstItem.querySelector('.js-date').innerHTML}/${firstItem.getAttribute('data-month')}`
            ...
            gridCells.forEach((el, i) => {
                el.addEventListener('click', () => {
                    ...
                    if (completeState) {
                        ...
                        const monthName2 = firstItem.getAttribute('data-month')
                        let monthNum2 = ""
                        switch (monthName2) {
                            case 'jan':
                                monthNum2 = "1";
                        ...
                        const monthNameLast = lastItem.getAttribute('data-month')
                        let monthNumLast = ""
                        switch (monthNameLast) {
                            case 'jan':
                                monthNumLast = "1";
                                break;
                            case 'feb':
                        ...
                        //firstDate.innerHTML = `${firstItem.getAttribute('data-week')} ${firstItem.querySelector('.js-date').innerHTML} ${firstItem.getAttribute('data-month')}`
                        const s = (`2024/${monthNum2}/${firstItem.querySelector('.js-date').innerHTML} -`).trim()
                        const e = (`2024/${monthNumLast}/${lastItem.querySelector('.js-date').innerHTML}`).trim()
                        firstDate.innerHTML = s
                        //lastDate.innerHTML = `${lastItem.getAttribute('data-week')} ${lastItem.querySelector('.js-date').innerHTML} ${lastItem.getAttribute('data-month')}`
                        lastDate.innerHTML = e
